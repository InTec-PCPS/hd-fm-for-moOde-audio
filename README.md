...
- Stations are added to moOde audio like any other streaming radio station. Stream URLs are formatted like this:
  - <pre>http://127.0.0.1:8080/tune?freq=93.3&prog=0</pre> (for HD. prog 0 is HD-1)
  - <pre>http://127.0.0.1:8081/fmtune?freq=102.3</pre> (for FM.)
...
- add user to plugdev and audio groups (<pre>sudo usermod -aG plugdev [username]</pre> and <pre>sudo usermod -aG audio [username]</pre>).
